...
export default function Css(){
    ...
    return(
        <form>
            <input type="text" className="form-control mb-4 w-75" placeholder="Associate Name"/>

            <input type="number" className="form-control mb-4 w-75" placeholder="Associate Id"/>

            <input type="text" className="form-control mb-4 w-75" placeholder="Project Id"/>
           ...
           <div className="row">
           {
            ...
            <input type="file" id="f" className="form-control mt-1 w-75" placeholder="Choose a file" />

            {/* TextArea */}
            <textarea className="form-control mt-4 w-75" placeholder="Comments" />
